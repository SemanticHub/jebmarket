...
$this->menu = array(
    array('label' => Yii::t('phrase', 'Create A Location Level'), 'url' => array('create')),
...
<h1 class="page-title">Manage Location Levels</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
            'name' => 'parent_id',
            'value' => 'LocationLevel::model()->findByPk($data->parent_id)->name'
        ),
        'code',
        'dial_code',
        //'parent_id',
