                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        if(isset($this->storeLinks) && sizeof($this->storeLinks) > 0 ) {
                            foreach($this->storeLinks as $linkItem) {
                                ?>
                                <li><a <?php if(isset($linkItem['id'])) { ?>id="<?php echo $linkItem['id']; }?>" <?php if(isset($linkItem['class'])) { ?> class="<?php echo $linkItem['class'];} ?>" href="<?php echo (is_array($linkItem['url'])) ? $this->createUrl($linkItem['url'][0]) : $linkItem['url']; ?>"><?php echo $linkItem['icon'].' ' ?> <?php echo $linkItem['label'] ?></a></li>
                            <?php
                            }
                        }
                        ?>
