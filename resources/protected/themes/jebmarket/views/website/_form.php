...
<div class="form-group">
    <?php echo $form->labelEx($model, 'domain', array('class' => 'control-label col-lg-3')); ?>
    <div class="col-lg-9">
...
<div class="form-group">
    <?php echo $form->labelEx($model, 'meta_desc', array('class' => 'control-label col-lg-3')); ?>
    <div class="col-lg-9">
...
<div class="form-group">
    <?php echo $form->labelEx($model, 'meta_keywords', array('class' => 'control-label col-lg-3')); ?>
    <div class="col-lg-9">
