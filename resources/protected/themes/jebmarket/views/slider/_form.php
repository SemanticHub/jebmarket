        ...
        <div class="col-lg-9">
            <div class="fileupload fileupload-new" data-provides="fileupload">
                ...
                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                    <img
                        src="<?php echo ($model->oldSlideImage) ? Yii::app()->baseUrl . '/' . Yii::app()->params['uploadUrl'] . $model->oldSlideImage : 'http://www.placehold.it/200x150/EFEFEF/AAAAAA&text=no+image' ?>"/>
                </div>
