...
class TemplateController extends Controller
{
	...
	{
        $userTemplate = UserTemplate::model()->findAll(array('condition' => 'jebapp_user_id=:user_id', 'order' => 'active DESC', 'params' => array(':user_id' => Yii::app()->user->id)));
